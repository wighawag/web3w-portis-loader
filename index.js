...
PortisModule.prototype.setup = async function(config) {
  ...
  const integrity = url ? (config.url_integrity || this.config.url_integrity) : "sha256-eVldFSMA1ifYTEJo1QXYPK7v+V+CNCEP4Xsp5/aAVQ8=";
  url = url || "https://cdn.jsdelivr.net/npm/@portis/web3@2.0.0-beta.2.0.0-beta.49/umd/index.js";
